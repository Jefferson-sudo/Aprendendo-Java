...
public class TelaFatorial extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int n = Integer.parseInt(txtN.getValue().toString());//converter valor caractere para inteiro "Integer.parseInt(txtNome.getValue().toString())"
        Fatorial f = new Fatorial();
        f.setValor(n);
        lblFormula.setText(f.getFormula());
        lblResultado.setText(Integer.toString(f.getFatorial()));//converter valor inteiro para caractere "Integer.toString(nome.get.)"
